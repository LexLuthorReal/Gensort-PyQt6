...
from PyQt6.QtCore import QObject, pyqtSlot, QAbstractListModel, QUrl
...
class Gensort(QObject):
    ...
    @pyqtSlot(name="categories_count", result=int)
    def get_categories_count(self) -> int:
        return self.categories_count

    @pyqtSlot("QAbstractListModel*", QUrl, name="export_data", result=bool)
    def save_data(self, model: QAbstractListModel, save_folder: QUrl) -> bool:
        """
        Documentation:
        1. https://doc.qt.io/qtforpython-5/PySide2/QtCore/QAbstractItemModel.html
        2. https://doc.qt.io/qtforpython-5/PySide2/QtCore/QAbstractListModel.html
    ...
    @pyqtSlot(QUrl, bool, name="photos_from_folder", result=list)
    def get_photos_from_folder(self, current_folder: QUrl, include_subdir: bool) -> List[Union[List]]:
...
if __name__ == "__main__":
    ...
    if categories_count is None:
        categories_count = MINIMAL_CATEGORIES_COUNT
    elif isinstance(categories_count, str):
    ...
    # Create object UI
    photo_sorter = Gensort(app=application, categories_count=categories_count)
    # Create QML Engine
